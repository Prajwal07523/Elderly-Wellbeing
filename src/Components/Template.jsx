...
const Template = (props) => {
  ...
  return (
    <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between text-gray-800">
      <div className="relative w-11/12 max-w-[450px]">
        <img src={frame} alt="patter" width={400} height={504} loading="lazy" />
        <img
          src={props.image}
          alt="patter"
          width={558}
      ...
      <div className="w-11/12 max-w-[450px] flex flex-col">
        ...
        <div className="flex w-full items-center gap-x-2 my-4">
          ...
          <p className="uppercase text-gray-800 font-medium leading-[1.375rem]">
            or
          </p>
          <div className="h-[1px] bg-richblack-700 w-full"></div>
        </div>
